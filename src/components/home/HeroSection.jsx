...
const HeroSection = () => {
  ...
  return (
    <div className="flex xl:flex-row flex-col gap-5 relative z-0 max-w-[1440px] mx-auto">
      <div className="flex-1 pt-36 p-x max-[1024px]:pt-10 max-[1024px]:px-10 max-[700px]:px-5 max-[700px]:pt-5 max-[700px]:p-5">
      ...
      <div className="xl:flex-[1.5] flex justify-end items-end w-full xl:h-screen relative">
        <div className="relative xl:w-full w-[90%] xl:h-full z-0 max-[1024px]:-z-20 max-[700px]:-z-10">
          <img src={HeroImage} alt="" />
          <div className="absolute max-[1024px]:-top-44 max-[700px]:-top-36 max-[350px]:-top-48 xl:-top-24 bg-bg-hero bg-repeat-round -z-10 w-full xl:h-screen h-[590px] max-[700px]:h-[400px] overflow-hidden" />
        </div>
      </div>
    </div>
  );
